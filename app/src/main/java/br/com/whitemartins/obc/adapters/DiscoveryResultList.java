...
import br.com.whitemartins.obc.util.UIHelper;

public abstract class DiscoveryResultList extends Activity implements DiscoveryHandler {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ExpandableListView expandableListView = findViewById(R.id.listPrinters);
    expandableListView.setAdapter(mExpListAdapter);
  }
  ...
  public void discoveryFinished() {
    runOnUiThread(new Runnable() {
      public void run() {
        Toast.makeText(DiscoveryResultList.this, " Discovered " + mExpListAdapter.getGroupCount() + " customerPatients", Toast.LENGTH_SHORT).show();
